<nav x-data="{ open: false }" class="bg-white sticky top-0 border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('weekly')" :active="request()->routeIs('weekly')">
                        {{ __('Week by Week Results') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('overall')" :active="request()->routeIs('overall')">
                        {{ __('Overall Standings') }}
                    </x-nav-link>
                </div>

                @can('admin_area')
                    <div class="hidden sm:flex sm:items-center pl-3 sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('games.index')" :active="request()->routeIs('games.index')">
                                    {{ __('Games') }}
                                </x-dropdown-link>
                                ...
                                <x-dropdown-link :href="route('weeks.index')" :active="request()->routeIs('weeks.index')">
                                    {{ __('Week') }}
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('current')" :active="request()->routeIs('current')">
                {{ __('Current Week Results') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('weekly')" :active="request()->routeIs('weekly')">
                {{ __('Week by Week Results') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('overall')" :active="request()->routeIs('overall')">
                {{ __('Overall Standings') }}
            </x-responsive-nav-link>
        </div>
        ...
        @can('admin_area')
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="px-4">
                    <div class="font-medium text-base text-gray-900">Admin</div>
                </div>

                <div class="mt-3 pl-4 space-y-1 text-xs text-gray-700">
                    ...
                    <x-responsive-nav-link :href="route('weeks.index')" :active="request()->routeIs('weeks.index')">
                        {{ __('Weeks') }}
                    </x-responsive-nav-link>
